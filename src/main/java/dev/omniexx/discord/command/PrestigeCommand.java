...
import dev.omniexx.service.PrestigeService;
...
public class PrestigeCommand extends ListenerAdapter {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        if (valuation < PrestigeService.getMinValuation()) {
            event.reply("🔒 Prestige erst ab **$1M Valuation** verfügbar.\n" +
                    "Aktuell: **" + OmniexxEmbedBuilder.formatMoney(valuation) + "**\n" +
                    "Noch " + OmniexxEmbedBuilder.formatMoney(PrestigeService.getMinValuation() - valuation) + " bis zum Ziel.")
                    .setEphemeral(true).queue();
            return;
        }

        EmbedBuilder eb = OmniexxEmbedBuilder.base("🌟 Prestige — Wähle deine Option", OmniexxEmbedBuilder.blue())
                ...
                .addField("Deine Firma",
                        "Valuation: " + OmniexxEmbedBuilder.formatMoney(valuation) + "\n" +
            ...
            if ("hard_reset".equals(type)) {
                ...
                event.editMessage("** **")
                        ...
                        .queue(hook -> hook.editOriginalEmbeds(
                                OmniexxEmbedBuilder.base("✅ Soft Prestige abgeschlossen!", OmniexxEmbedBuilder.green())
    ...
    private void doHardReset(ButtonInteractionEvent event, Company company, Employee carried) {
        ...
        event.editMessage("** **")
                .setComponents()
                .queue(hook -> hook.editOriginalEmbeds(
                        OmniexxEmbedBuilder.base("🔄 Hard Reset abgeschlossen!", OmniexxEmbedBuilder.green())
                                ...
                                .addField("Startkapital",  OmniexxEmbedBuilder.formatMoney(newCompany.getCapital()), true)
