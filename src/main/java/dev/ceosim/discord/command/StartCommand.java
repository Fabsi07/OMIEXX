...
public class StartCommand extends ListenerAdapter {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        event.reply("## 🏢 Willkommen bei CEO Sim!\n\nWähle deinen **Startmarkt**:")
                .addActionRow(
            ...
            event.editMessage("** **")   // leere Nachricht, dann Embed
                    ...
                    .queue(hook ->
                            hook.editOriginalEmbeds(
                                    CeoEmbedBuilder.base("🎉 " + companyName + " wurde gegründet!", CeoEmbedBuilder.green())
                                            ...
                                            .addField("💰 Startkapital",  CeoEmbedBuilder.formatMoney(company.getCapital()), true)
                                            ...
                                            .setFooter("CEO Sim • " + type.getDescription())
                                            .build()
                            ).queue()
                    );
        }
