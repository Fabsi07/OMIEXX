...
public class FireCommand {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        try {
            ...
            EmbedBuilder eb = CeoEmbedBuilder.base("🚪 Mitarbeiter entlassen", CeoEmbedBuilder.red())
                    ...
                    .addField("Ersparnis", CeoEmbedBuilder.formatMoney(match.getSalaryPerTick()) + "/Tick weniger Burnrate", false)
